...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const bump = core.getInput('bump').replace(/\s/g, '');
        ...
        if (godotVersion.toLowerCase().includes('global')) {
            ...
            godotVersion = (_c = globalJson['msbuild-sdks']['Godot.NET.Sdk']) !== null && _c !== void 0 ? _c : '';
        }
        core.info(`🤖 Godot version: ${godotVersion}`);
        core.endGroup();
        // Compute next version
        const semanticProjectVersion = (0, utils_1.parseVersion)(projectVersion);
        const semanticGodotVersion = (0, utils_1.parseVersion)(godotVersion);
        const version = (0, utils_1.nextVersion)(semanticProjectVersion, semanticGodotVersion, bump);
        // Output next version
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.nextVersion = exports.parseVersion = void 0;
/**
 * Official semantic version regex.
 * See https://semver.org
 */
const SEMANTIC_VERSION_REGEX = /^(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(?:-((?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\.(?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\+([0-9a-zA-Z-]+(?:\.[0-9a-zA-Z-]+)*))?$/;
 ...
 */
function nextVersion(projectVersion, godotVersion, bump) {
